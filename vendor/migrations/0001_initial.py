    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('product', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='receipts', to='vendor.product')),
        ...
        migrations.AddField(
            model_name='offer',
            name='bundle',
            field=models.ManyToManyField(related_name='bundles', to='vendor.Product'),
        ),
        migrations.AddField(
            model_name='offer',
            name='product',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='offers', to='vendor.product'),
        ),
        migrations.AddField(
            model_name='offer',
            name='site',
            field=models.ForeignKey(default=1, on_delete=django.db.models.deletion.CASCADE, related_name='product_offers', to='sites.site'),
        ),
        migrations.AddField(
            model_name='address',
            name='profile',
