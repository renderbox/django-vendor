...
class ProductOffer(CreateUpdateModelBase):
    ...
    product = models.ForeignKey(settings.PRODUCT_MODEL, verbose_name=_("Product"), on_delete=models.CASCADE, related_name="product_offer")
    ...
    priority = models.PositiveIntegerField(_("Priority"), default=10, help_text="Higher number overrides prices with lower numbers in the same date range.")
