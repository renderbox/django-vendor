...
class Receipt(CreateUpdateModelBase):
    ...
    product = models.ForeignKey(VENDOR_PRODUCT_MODEL, on_delete=models.CASCADE, related_name="receipts", blank=True, null=True)           # TODO:  Goal is to make it easier to check to see if a user owns the product. WHAT IF IT IS A BUNDLE
