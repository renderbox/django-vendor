...
urlpatterns = [
    ...
    path('stripe/invoice/payment/succeded/', stripe_views.StripeInvoicePaymentSuccededEvent.as_view(), name='api-stripe-invoice-payment-succeded'),
    ...
    path('stripe/invoice/upcoming/', stripe_views.StripeInvoiceUpcomingEvent.as_view(), name='api-stripe-invoice-upcoming'),
]