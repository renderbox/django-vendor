...
urlpatterns = [
    ...
    path('stripe/subscriptions/', admin_views.AdminStripeSubscriptionListView.as_view(), name="manager-stripe-subscriptions"),
    path('stripe/subscription/<uuid:uuid>/recreate/', admin_views.AdminStripeSubscriptionReCreate.as_view(), name='manager-stripe-subscription-recreate'),
